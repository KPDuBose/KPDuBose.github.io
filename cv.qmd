---
author: Kline DuBose
title: Doctoral Student, Populaiton Health Sciences, Division of Biostatistics
format:
...
tibble::tribble(
  ...
  "Graduate Research Assistant", "University of Utah", "Aug 2022-Present", "placeholder", c("Collaborate on statistical design, analysis, and reporting for clinical and observational health studies", 
                                                                                               "\\textit{AID}: AI tool development to simplify project assignment at the Biostatisitcs Core at the Huntsmand Cancer Institute. (2025-Present)",
                                                                                               "\\textit{PT-IN-MIND}: NIH funded feasibility trial. Data safety monitor. Generated reports for IMC meetings. (2023-Present)", 
                                                                                               "\\textit{ImmPETUS}: Study conducted to examine the social health impacts of different cancers. Conducted data cleaning, variable definition, and statistical analyses for cancer outcomes research. (2023-2024)",
                                                                                               "\\textit{INTERSECT}: Study using flatiron data to examine socioeconomic differences in patients receiving immunotherapy. Conducted data cleaning, variable definition, and statistical analyses for cancer outcomes research. (2023-2024)")
...
tibble::tribble(
  ~reference,
  "\\textbf{DuBose, K.}, Chipman, J., Villar, S., \\& Pin, L. (March 2026). Similarity Weighted Covariate Adjusted Response Adaptive (SW-CARA) Clinical Trials. Poster presentation at ENAR 2026 Spring Meeting, Indianapolis, IN.",
  "Tay, DL, \\textbf{Dubose, K}, Chipman, J, Alnajar,M, Ellington, L, Iacob, E, Stephens, C, \\& Ornstein, KA. (September 2024). Risk of mental health disorders in bereavement: A population-based analysis of lung cancer spouses. Poster presentation at the National Center on Family Support’s 3rd Biennial Conference on Caregiving Research, Pittsburgh, PA.",
  "Tay, D. L., \\textbf{Dubose, K.}, Meeks, H., Guo, J-W., Alekhina, N., Feldner, K., Sheng, X. Chipman, J., Ellington, L., \\& Hashibe, M.. (March, 2024). Inpatient and ED use among melanoma and lung cancer patients receiving immune checkpoint inhibitors. Poster presentation at the 2024 State of the Science in Hospice and Palliative Care, Phoenix, AZ."
) |> reference(ref = "reference")
```
...
tibble::tribble(
  ~role, ~institution, ~dates, ~details, ~tasks,
  "Chair at Student Research Conference", "Brigham Young University", "Feb. 2026", "Student research conference at BYU", c("Guided discussion on student research projects", "Assisted in selecting session winners")
) |>
  cvevents(when = "dates", what = "role", where = "institution", details = "tasks")
...
tibble::tribble(
  ~skill, ~det,
  "Programming Languages", c("R", "SAS", "C++", "Python"),
  "Languages", c("English (native)", "Spanish (conversational proficiency)")
