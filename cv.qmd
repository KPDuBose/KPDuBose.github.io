...
tibble::tribble(
  ...
  "Graduate Research Assistant", "University of Utah", "Aug. 2022 - Present", "placeholder", c("Help researchers assess statistical feasebility of research", 
                                                                                               "\\textit{PT-IN-MIND}: NIH funded feaseability trial. Data safety monitor. Generated reports for IMC meetings. (2023 - Present)", 
                                                                                               ...
                                                                                               "\\textit{INTERSECT}: Study using flatiron data to examine socioeconimic differences in patients receiving immunotherapy. Helped with numerous analyses and data cleaning. (2023-2024)")
...
tibble::tribble(
    ...
    "Teaching Assistant - R Coding Bootcamp", "University of Utah", "June 2023 - Present", "DELPHI", c("Helped teach introductory and advanced R Coding Bootcamps", "Provided assitance, as needed, to participants in the bootcamps"),
...
tibble::tribble(
  ~role, ~institution, ~dates, ~details, ~tasks,
  "Judge at Student Reserach Conference", "Brigham Young University", "Mar. 2025", "Student research conference at BYU", c("Provided feedback on student reserach projects in the machine learning space.", "Selected session winners")
) |>
    cvevents(when = "dates", what = "role", where = "institution", details = "tasks")
```
